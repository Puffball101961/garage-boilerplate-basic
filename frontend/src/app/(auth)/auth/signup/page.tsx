...
export default function SignUpPage() {
  ...
  return (
    <div className="space-y-10">
      <h1 className="text-center text-2xl font-semibold tracking-tight">Sign Up Page</h1>
      ...
      {/* Mirrors the login page: Google sits below the primary action rather
          than competing with the email/password path. */}
