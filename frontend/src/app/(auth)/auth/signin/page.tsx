...
export default function SignInPage() {
  ...
  return (
    <div className="space-y-10">
      <h1 className="text-center text-2xl font-semibold tracking-tight">Login Page</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm shadow-sm placeholder:text-zinc-400 focus:ring-2 focus:ring-blue-500 focus:outline-none aria-invalid:border-red-500 dark:border-zinc-700 dark:bg-zinc-900"
      ...
      {/* Google is not in the design, so it sits below the primary action and
          reads as the secondary way in rather than competing with it. */}
